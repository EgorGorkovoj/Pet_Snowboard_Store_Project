...
def upgrade() -> None:
    ...
    op.create_table('categoryattribute',
    ...
    sa.Column('payment_method', sa.Enum('CARD', 'SBP', 'CASH_ON_DELIVERY', 'CARD_ON_DELIVERY', name='payment_method'), nullable=True),
    ...
    op.create_table('productoptionattribute',
    sa.Column('variant_id', sa.Integer(), nullable=False),
    sa.Column('attribute_id', sa.Integer(), nullable=False),
    sa.Column('value', sa.String(length=50), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['attribute_id'], ['attribute.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['variant_id'], ['productoption.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('productoptionattribute')
